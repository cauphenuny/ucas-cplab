...
inline const auto BUILTIN_FUNCS = [] {
    ...
    v.emplace_back(FuncDef{
        .type = ast::Type::VOID, .name = "print_float", .params = {{.type = ast::Type::FLOAT}}});
    v.emplace_back(FuncDef{
        .type = ast::Type::VOID, .name = "print_double", .params = {{.type = ast::Type::DOUBLE}}});
    v.emplace_back(FuncDef{
